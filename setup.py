...
setup(
  ...
  download_url = 'https://github.com/markomanninen/hyml/archive/v0.1.4.tar.gz', # I'll explain this in a second
  keywords = ['hylang', 'python', 'lisp', 'markup language', 'dsl', 'xml', 'html', 'xhtml'], # arbitrary keywords
  platforms = ['any'],
